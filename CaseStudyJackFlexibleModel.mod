...
# model CaseStudyJackFlexibleModel.mod;
# solve;

# display _varname, _var;
# display _conname, _con.current;

############# Jack's model: Cost Minimization w/ Flexible Composition   ##############
...
subject to IngofC1: 0.15*50 <= 0.4*ing1 + 0.2*ing2 + 0.8*ing3 + 0.8*ing4 + 0.9*ing5 + 0.1*ing6 + 0.5*ing10 + 0.6*ing11 <= 0.17*50;
subject to IngofC2: 0.07*50 <= 0.1*ing1 + 0.1*ing4 + 0.1*ing6 + 0.3*ing7 + 1*ing8 <= 0.09*50;
subject to IngofC3: 0.1550*50 <= 0.7*ing9 + 0.1*ing10 <= 0.1650*50;
subject to IngofC4: 0.0030*50 <= 0.4*ing10 + 0.4*ing11 <= 0.0040*50;
subject to IngofC5: 0.0020*50 <= 1*ing12 <= 0.0030*50;
subject to IngofC6: 0.0010*50 <= 1*ing13 <= 0.0020*50;
subject to IngofC7: 0.58*50 <= 0.5*ing1 + 0.8*ing2 + 0.2*ing3 + 0.1*ing4 + 0.1*ing5 + 0.8*ing6 + 0.7*ing7 + 0.3*ing9 + 1*ing14 <= 0.5950*50; 
